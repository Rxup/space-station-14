...
// start-backmen: mining-points
using Content.Shared._DV.Salvage.Components;
using Content.Shared._DV.Salvage.Systems;
// end-backmen: mining-points
...
public sealed partial class LatheMenu : FancyWindow
{
    ...
    private readonly MiningPointsSystem _miningPoints; // backmen: mining-points

    public event Action<BaseButton.ButtonEventArgs>? OnServerListButtonPressed;
    public event Action<string, int>? RecipeQueueAction;
    public event Action? OnClaimMiningPoints; // backmen: mining-points
    ...
    private uint? _lastMiningPoints; // backmen: mining-points
    ...
    public LatheMenu()
    {
        ...
        _miningPoints = _entityManager.System<MiningPointsSystem>(); // backmen: mining-points
