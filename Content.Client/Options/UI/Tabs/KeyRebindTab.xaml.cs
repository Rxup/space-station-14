...
using BackmenCCvars = Content.Shared._Backmen.CCVar;
...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        public KeyRebindTab()
        {
            ...
            {
                _cfg.SetCVar(Shared._Backmen.CCVar.CCVars.AutoGetUp, args.Pressed);
                _cfg.SaveToFile();
            }
            ...
            AddCheckBox("ui-options-hotkey-auto-up", _cfg.GetCVar(Shared._Backmen.CCVar.CCVars.AutoGetUp), HandleToggleAutoGetUp); // backmen: Laying System
            InitToggleWalk();
