using Content.Client._Backmen.Shipyard.UI;
using Content.Shared._Backmen.Shipyard.BUI;
using Content.Shared._Backmen.Shipyard.Events;
using Robust.Client.GameObjects;
using static Robust.Client.UserInterface.Controls.BaseButton;

namespace Content.Client._Backmen.Shipyard.BUI;

public sealed class ShipyardConsoleBoundUserInterface : BoundUserInterface
{
    [ViewVariables] private ShipyardConsoleMenu? _menu;

    [ViewVariables] public int Balance { get; private set; }
