using System.Linq;
using Content.Client._Backmen.GhostTheme;
...
namespace Content.Client._Backmen.SponsorManager.UI;
...
public sealed partial class SponsorWindow : DefaultWindow
{
    ...
    protected override void Opened()
    {
        ...
        var selectedGhost = _cfg.GetCVar(Shared._Backmen.CCVar.CCVars.SponsorsSelectedGhost);
        var selectedInt = -1;
    ...
    private void GhostThemeChange(OptionButton.ItemSelectedEventArgs e)
    {
        ...
        _cfg.SetCVar(Shared._Backmen.CCVar.CCVars.SponsorsSelectedGhost, selectedGhost);
        _cfg.SaveToFile();
    }
}
