...
ent-Ointment = ointment
    .desc = Used to treat those nasty burns. Less effective on caustic burns. Does not stop bleeding. For heavy blood loss, use a medicated suture, gauze, or surgery.
    .suffix = Full
...
ent-RegenerativeMesh = regenerative mesh
    .desc = Used to treat even the nastiest burns. Also effective against caustic burns. Does not stop bleeding. For heavy blood loss, use a medicated suture, gauze, or surgery.
    .suffix = Full
ent-OintmentAdvanced1 = { ent-RegenerativeMesh }
    .suffix = Single
    .desc = { ent-RegenerativeMesh.desc }
ent-Brutepack = bruise pack
    .desc = A therapeutic gel pack and bandages designed to treat blunt-force trauma. Does not stop bleeding. For bleeding, use a suture, gauze, or surgery (clamp bleeders).
    .suffix = Full
...
ent-MedicatedSuture = medicated suture
    .desc = A suture soaked in medicine, treats blunt-force trauma effectively and closes wounds. Stops light and moderate bleeding. Heavy blood loss requires surgery.
    .suffix = Full
...
ent-Gauze = roll of gauze
    .desc = Some sterile gauze to wrap around bloody stumps. Stops light and moderate bleeding. Heavy blood loss requires surgery.
    .suffix = Full
