...
ent-WeaponRevolverDeckard = Deckard
    .desc = A rare, custom-built revolver. Use when there is no time for Voight-Kampff test. Uses .357 magnum ammo.
ent-WeaponRevolverInspector = Inspector
    .desc = A detective's best friend. Uses .357 magnum ammo.
ent-WeaponRevolverMateba = Mateba
    .desc = The iconic sidearm of the dreaded death squads. Uses .357 magnum ammo.
...
ent-WeaponRevolverPython = Python
    .desc = A robust revolver favoured by Syndicate agents. Uses .357 magnum ammo.
...
ent-WeaponRevolverPirate = pirate revolver
    .desc = An odd, old-looking revolver, favoured by pirate crews. Uses .357 magnum ammo.
