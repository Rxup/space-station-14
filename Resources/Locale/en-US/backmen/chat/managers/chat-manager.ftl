...
chat-manager-send-Flesh-chat-wrap-message = FLESH: {$message}
chat-manager-send-Flesh-chat-wrap-message-admin = {$source} (FLESH): {$message}
chat-manager-Flesh-channel-name = FLESH
