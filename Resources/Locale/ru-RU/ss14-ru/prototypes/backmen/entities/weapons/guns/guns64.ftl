...
ent-PowerpackRifle = силовой ранец (.25 безгильзовые)
...
ent-WeaponMultiphaseEnergyGun = X-01 мультифазовый лазерный пистолет
    .desc = Первая попытка Nanotrasen модифицировать антикварный лазерный пистолет. Имеет больше режимов для стрельбы, однако не может самозаряжаться.
