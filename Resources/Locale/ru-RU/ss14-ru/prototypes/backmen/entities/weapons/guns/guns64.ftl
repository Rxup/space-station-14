...
ent-PowerpackRifle = силовой ранец (.15 безгильзовые)
    .desc = Сверх-тяжелый ранец набитый патронами, крепиться к силовому креплению, что значительно разгружает вес для оператора, имеет ленточную систему подачи боеприпас.
...
ent-PowerpackEnergyPulse = силовой ранец (импульсный)
    .desc = Сверх-тяжелый ранец с системой "Powerpack", крайне взрыво-опасен из-за сверх-проводящих батарей внутри корпуса наполненых охлажденной жидкой плазмой.
