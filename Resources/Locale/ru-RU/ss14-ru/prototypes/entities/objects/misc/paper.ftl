...
ent-BoxFolderBase = папка
    .desc = Папка, набитая секретными бумагами.
...
ent-BoxFolderCentComClipboard = планшет CentComm
    .desc = Роскошный планшет с зелёным бархатом. Часто носят чиновники CentComm, редко используют.
ent-BoxFolderQmClipboard = электронная доска заявок
    .desc = Громоздкий электронный планшет с заказами и финансами. Столько компромата — храните в безопасности.
