...
ent-GrenadeBase = { ent-BaseItem }
    .desc = Корпус гранаты. Требуется спусковой механизм и заряд.
ent-SmokeGrenade = дымовая граната
    .desc = Тактическая граната, выпускающая большое долгое облако дыма.
ent-CleanerGrenade = чистящая граната
    .desc = Специальная граната для уборщиков, выпускающая облако космической чистящей пены.
ent-TearGasGrenade = граната со слезоточивым газом
    .desc = Граната со слезоточивым газом для подавления беспорядков. Вызывает раздражение, боль и слёзы.
ent-MetalFoamGrenade = граната с металлической пеной
    .desc = Аварийный инструмент для заделки дыр. Почти как настоящие стены.
