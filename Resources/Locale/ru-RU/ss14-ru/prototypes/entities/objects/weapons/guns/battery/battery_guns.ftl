...
ent-WeaponTemperatureGun = температурная винтовка
    .desc = Продвинутое вооружение, которое стреляет изменяющими температуру снарядами. Скорее всего, его использование можно приписать к какому-то военному преступлению.
...
ent-WeaponMultiphaseEnergyGun = мультифазная энергетическая пушка X-01
    .desc = Передовое энергетическое оружие с несколькими режимами стрельбы.
