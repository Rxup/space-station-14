...
ent-Baton = дубинка глав
    .desc = Особая дубинка которая даётся главам.
ent-TelescopicBaton= Телескопическая дубинка ЦК
    .desc = Телескопическая дубинка сделаная специально для представителей ЦК.
