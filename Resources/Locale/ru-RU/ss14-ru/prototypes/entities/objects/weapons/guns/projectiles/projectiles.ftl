...
ent-BulletTaser = заряд тазера
    .desc = { ent-BaseBullet.desc }
ent-BulletTaserSuper = заряд супер-тазера
    .desc = Если ты видишь это, тебя, вероятно, оглушили
...
ent-WatcherBoltMagmawing = заряд наблюдателя-магмакрыла
    .desc = { ent-BaseBullet.desc }
ent-WatcherBoltIcewing = заряд наблюдателя ледяное крыло
    .desc = { ent-BaseBullet.desc }
...
ent-BulletGrenadeFrag = осколочная граната
    .desc = { ent-BaseBulletTrigger.desc }
ent-BulletGrenadeCleanade = патрон гранаты чистящего средства
    .desc = { ent-BaseBulletTrigger.desc }
...
ent-BulletWaterShot = вода
    .desc = { "" }
ent-BulletSplashAcid = кислотный плевок плоти
    .desc = { ent-BaseBulletTrigger.desc }
ent-StickyHandPalm = ладонь липкой руки
    .desc = { ent-GrapplingHook.desc }
ent-BulletHivebot = пуля ульевого бота
    .desc = { ent-BaseBullet.desc }
ent-BulletCannonBall = пушечное ядро
    .desc = { ent-BaseBulletTrigger.desc }
ent-GrapplingHook = якорь
    .desc = { "" }
ent-BaseBulletHighVelocity = базовая пуля высокой скорости
    .desc = { ent-BaseBullet.desc }
ent-BulletRobotBall = ракета
    .desc = { ent-BaseBulletTrigger.desc }
...
ent-BulletEnergyTurretDisabler = заряд станнера
    .desc = { ent-BulletEnergyTurretBase.desc }
ent-BulletLaserMagnum = лазерный болт магнума
    .desc = { ent-BulletLaser.desc }
ent-BulletLaserWindowPiercingMagnum = болт магнума пробивающий окна
    .desc = { ent-BulletLaser.desc }
