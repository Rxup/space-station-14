...
ent-SolutionToolWelderMini = { ent-SolutionWelder }
    .desc = { ent-SolutionWelder.desc }
ent-RefuelingWelder = самовосполняющийся сварочный аппарат
    .desc = Медленный сварочный аппарат, который может сам восстанавливать своё топливо.
