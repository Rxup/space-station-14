...
ent-ProtolatheCashMachineCircuitboard = принтер кредитов (машинная плата)
...
ent-MaterialSiloMachineCircuitboard = ресурсный сервер (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
...
ent-CutterMachineCircuitboard = резательный станок (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
ent-SmartFridgeCircuitboard = плата машины Умного Холодильника
