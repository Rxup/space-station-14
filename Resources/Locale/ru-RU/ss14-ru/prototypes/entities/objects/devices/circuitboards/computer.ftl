...
ent-CargoRequestComputerCircuitboard = консоль заказов (консольная плата)
    .desc = Консольная плата для консоли заказа грузов.
ent-CargoRequestEngineeringComputerCircuitboard = консоль заказов (консольная плата)
    .desc = Консольная плата для консоли заказов инженерного отдела.
ent-CargoRequestMedicalComputerCircuitboard = консоль заказов (консольная плата)
...
ent-CargoRequestServiceComputerCircuitboard = консоль заказов (консольная плата)
    .desc = Консольная плата для консоли заказов сервиса.
ent-FundingAllocationComputerCircuitboard = консоль финансирования (консольная плата)
    .desc = Консольная плата для консоли финансирования.
...
ent-SalvageJobBoardComputerCircuitboard = плата компьютера доски работ по спасению
...
ent-XenoborgCameraMonitorCircuitboard = плата монитора камеры ксеноборга
...
ent-ComputerXenoborgsControlCircuitboard = плата консоли управления ксеноборга
