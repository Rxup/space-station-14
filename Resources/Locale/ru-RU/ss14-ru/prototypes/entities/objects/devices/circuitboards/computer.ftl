...
ent-StationAiUploadCircuitboard = консоль загрузки искусственного интеллекта (консольная плата)
    .desc = Консольная плата для консоли загрузки искусственного интеллекта.
