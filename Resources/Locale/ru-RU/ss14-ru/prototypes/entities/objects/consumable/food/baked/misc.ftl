...
ent-FoodBakedGrilledCheeseSandwichCotton = хлопковый сырный сэндвич
    .desc = Хлопковый сэндвич, обжаренный в масле, и с куском сыра между тостами. Нианам тяжело устоять от такого перекуса.
