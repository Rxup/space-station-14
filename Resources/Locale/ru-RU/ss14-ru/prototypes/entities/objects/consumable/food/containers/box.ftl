...
ent-FoodMealHappyHonkBigBite = обед Хэппи Хонк: Большой Укус
    .desc = Кто-то заплатил очень много денег, чтобы доставить этот фастфуд в таком виде. Пахнет свежим, каким-то образом..
