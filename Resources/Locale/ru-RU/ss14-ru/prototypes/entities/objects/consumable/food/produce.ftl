...
ent-FoodProduceBase = { ent-SolutionFood }
    .desc = { ent-SolutionFood.desc }
...
ent-FoodMushroom = гроздь лисичек
    .desc = Лисички обыкновенные: Эти весёлые жёлтые маленькие грибы выглядят очень аппетитно!
...
ent-FoodBloonion = луковица блуниона
    .desc = Странная плавающая луковица. Не о чем плакать.
