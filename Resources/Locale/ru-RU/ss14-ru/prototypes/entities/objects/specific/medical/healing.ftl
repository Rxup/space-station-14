...
ent-Ointment = мазь
    .desc = Используется для лечения этих неприятных ожогов. Менее эффективна при кислотных ожогах. Не останавливает кровотечение. При сильной кровопотере используйте медицинскую нить, марлю или хирургию.
    .suffix = Полный
...
ent-RegenerativeMesh = регенеративная сеть
    .desc = Применяется для лечения даже самых неприятных ожогов. Эффективна также при кислотных ожогах. Не останавливает кровотечение. При сильной кровопотере используйте медицинскую нить, марлю или хирургию.
    .suffix = Полный
...
ent-Brutepack = набор для ушибов
    .desc = Терапевтический набор гелей и пластырей, предназначенных для лечения ушибов. Не останавливает кровотечение. Для крови — нить, марля или зажимание кровоточащих сосудов на операционном столе.
    .suffix = Полный
...
ent-MedicatedSuture = медицинская нить
    .desc = Нить, пропитанная лекарством, эффективно лечит механические травмы и закрывает раны. Останавливает лёгкое и среднее кровотечение. При обильной кровопотере требуется хирургия.
    .suffix = Полный
...
ent-Gauze = марлевый бинт
    .desc = Несколько стерильных марлевых полосок для оборачивания кровоточащих культей. Останавливает лёгкое и среднее кровотечение. При обильной кровопотере требуется хирургия.
    .suffix = Полный
