...
ent-ClothingBeltMilitaryWebbingERT = разгрузка команды экстренного реагирования
    .desc = Набор тактической разгрузки, носимый оперативниками команды экстренного реагирования.
ent-ClothingBeltYamato = Ножны Ямато
    .desc = Ножны для Ямато. Найдено в секторе "Бекман"
ent-ClothingBeltYamatoFilled = { ent-ClothingBeltYamato }
    .suffix = Заполненный
    .desc = { ent-ClothingBeltYamato.desc }
