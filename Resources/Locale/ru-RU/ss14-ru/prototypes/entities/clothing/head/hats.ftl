...
ent-ClothingHeadHatBeretCommand = берет командования
    .desc = Берет с эмблемой командования на ней. У него есть сильная аура авторитета.
...
ent-ClothingHeadHatCanadaBeanie = канадская шапка
    .desc = Красная & белая. Излучает тёплое чувство, словно вы сидите у камина и пьёте теплый кофе.
...
ent-ClothingHeadHatSolidHeadband = солидная повязка
    .desc = Вы чувствуете себя Невидимым, надевая это на себя! (ДИСКЛЕЙМЕР: НЕ ДЕЛАЕТ НОСИТЕЛЯ НЕВИДИМЫМ НА САМОМ ДЕЛЕ)
