...
ent-ClothingOuterVestWebElite = элитный тактический жилет
    .desc = Синтетический бронежилет. У этого есть дополнительные термоустойчивые ткани.
...
ent-ClothingOuterArmorCentcommCarapace = панцирь центкомм
    .desc = Укреплённая броня, которая предоставляет высокую мобильность и удобство. Используется только сотрудниками Центрального Командования.
