...
ent-MobBaseAncestorCommon = генетический предок
    .desc = Генетический двуногий предок... э-э... чего-то. Да, на станции определённо есть что-то, произошедшее от кого бы это ни было.
    .suffix = { ent-SimpleMobBaseCore.suffix }
ent-MobBaseAncestor = { ent-MobBaseAncestorCommon }
    .desc = { ent-MobBaseAncestorCommon.desc }
    .suffix = { ent-MobBaseAncestorCommon.suffix }
ent-MobBaseAncestorSurgery = { ent-MobBaseAncestorCommon }
    .desc = { ent-MobBaseAncestorCommon.desc }
    .suffix = { ent-MobBaseAncestorCommon.suffix }
ent-MobBaseAncestorMonkey = { ent-AppearanceMonkey }
    .desc = { ent-MobBaseAncestorSurgery.desc }
    .suffix = { ent-MobBaseAncestorSurgery.suffix }
ent-MobMonkey = обезьяна
    ...
    .suffix = { ent-MobBaseAncestorMonkey.suffix }
