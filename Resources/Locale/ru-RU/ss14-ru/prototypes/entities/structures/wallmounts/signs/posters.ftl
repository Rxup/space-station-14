...
ent-PosterContrabandRealExomorph = Реально! Экзоморфы
    .desc = Конспирологический постер про опасные формы внеземной жизни.
...
ent-PosterContrabandRouny = Вы видели его?
    .desc = Старый плакат со старым пришельцем. Куда же он мог сбежать?
...
ent-PosterContrabandExoAcid = Предупреждение Экзоморфа: Кислотный Плевок!
    .desc = This poster warns you about an exomorph's acidic spit. Not that such exomorphs are real... Right?
ent-PosterContrabandExoRun = Предупреждение Экзоморфа: Убегай!
...
ent-PosterContrabandExoChomp = Предупреждение Экзоморфа: Опасные Укусы!
