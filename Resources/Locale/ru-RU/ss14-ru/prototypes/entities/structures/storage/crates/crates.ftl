...
ent-CrateRodentCage = хомячья клетка
    .desc = { ent-CrateGeneric.desc }
ent-CrateBaseLockBox = лок-бокс
    .desc = Защищённый лок-бокс. Деньги от его продажи пойдут обратно в его отдел. Напоминание: снабжение всегда получает некоторую часть.
ent-CrateLockBoxEngineering = инженерный лок-бокс
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxMedical = медицинский лок-бокс
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxScience = научный лок-бокс
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = лок-бокс службы безопасности
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = сервисный лок-бокс
    .desc = { ent-CrateBaseLockBox.desc }
