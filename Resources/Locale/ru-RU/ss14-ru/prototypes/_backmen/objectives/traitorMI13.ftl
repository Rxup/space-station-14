...
ent-KillRandomHeadObjectiveMI13 = { ent-BaseTraitorObjectiveMI13 }
    .desc = Нам нужно, чтобы этот глава исчез, и вы, вероятно, знаете, почему. Удачи, оперативник.
ent-BaseTraitorSocialObjectiveMI13 = { ent-BaseTraitorObjectiveMI13 }
    .desc = { ent-BaseTraitorObjectiveMI13.desc }
ent-RandomTraitorAliveObjectiveMI13 = { ent-BaseTraitorSocialObjectiveMI13 }
    .desc = Раскрывать себя или нет — решайте сами. Нам нужно, чтобы он выжил.
ent-RandomTraitorProgressObjectiveMI13 = { ent-BaseTraitorSocialObjectiveMI13 }
