...
ent-ActionShootWater = Распылить воду!
    .desc = Распылите воду в сторону ваших врагов.
...
ent-ActionGravityJump = Прыжок
    .desc = Активируя продвинутую систему движения, вы перемещаетесь на короткое расстояние в направлении вашего взгляда.
ent-ActionVulpkaninGravityJump = Прыжок
    .desc = Используйте свои проворные ноги, чтобы прыгнуть на короткое расстояние. Будьте осторожны, чтобы ни во что не врезаться!
ent-ActionToggleRootable = Укореняемый
    .desc = Начать или прекратить укоренение в пол.
ent-ActionChameleonController = Управление одеждой
    .desc = Быстро смените весь наряд!
