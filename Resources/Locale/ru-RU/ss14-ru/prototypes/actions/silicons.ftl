...
Ointment-action-name = Мазь от ожогов
...
CableMVStack-action-name = СВ провода
CableMVStack-action-description = Создаёт полный стак СВ проводов
CableHVStack-action-name = ХВ провода
CableHVStack-action-description = Создаёт полный стак ХВ проводов
SheetSteel-action-name = Сталь
SheetSteel-action-description = Создаёт полный стак стали
SheetPlasteel-action-name = Пласталь
SheetPlasteel-action-description = Создаёт полный стак пластали
SheetGlass-action-name = Стекло
SheetGlass-action-description = Создаёт полный стак стекла
SheetRGlass-action-name = Укреплённое стекло
