...
ent-ClothingBackpackDuffelSyndicateFilledRifle = набор "Estoc DMR"
    .desc = Для стрельбы на средних дистанциях - Estoc DMR. В комплекте с тремя магазинами.
...
ent-ClothingBackpackDuffelSyndicateOperativeMedic = вещмешок медика-оперативника
    .desc = Большой вещевой мешок для хранения дополнительных медицинских припасов.
...
ent-ClothingBackpackDuffelAcolyteBundle = набор доспехов послушника
    .desc = Содержит доспехи послушника - обязательный атрибут любого лидера культа.
ent-ClothingBackpackDuffelSyndicateFilledStarterKit = базовый набор оперативника
    .desc = Содержит оружие, медицинские припасы, инструменты для взлома, запасные патроны и некоторые простые утилиты.
ent-ClothingBackpackDuffelSyndicateFilledHushpup = набор "Hushpup"
    .desc = Содержит Hushpup в комплекте с коробкой картечи. Включена четверть.
