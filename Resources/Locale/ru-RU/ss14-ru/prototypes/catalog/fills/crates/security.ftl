...
ent-CrateSecNonlethalThrowables = ящик нелетальных снарядов
    .desc = Включает в себя по коробке светошумовых, станящих, и слезоточивых гранат, а также 4 болы. Требует доступ Службы Безопасности для разблокировки.
