...
ent-CrateFoodGetMore = ящик Getmore Bakemore
    .desc = Закуски и принадлежности для выпечки бренда Getmore для творческого шеф-повара, всё без необходимости опустошать торговые автоматы Getmore на станции!
ent-CrateFoodIceCream = доставка мороженого
    .desc = Ассортимент мороженых лакомств на любой случай! Включает 16 замороженных угощений.
ent-CrateFoodSnowcone = доставка снежных конусов
    .desc = Морозильник, набитый освежающими снежными конусами для усердно работающей команды, или даже для ленивой! Включает 16 снежных конусов.
ent-CrateFoodHappyHonkBigBite = доставка еды Happy Honk
    .desc = Два полностью загруженных бургерных набора Happy Honk Big Bite, в комплекте с сырным картофелем фри, бутылкой Space Cola, кусочком яблочного пирога и игрушкой!
