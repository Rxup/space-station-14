...
ent-CrateServiceCleanerGrenades = ящик чистящих гранат оптом
    .desc = Содержит две коробки чистящих гранат для самых въевшихся пятен.
...
ent-CrateServiceColorfulLights = ящик разноцветных огней
    .desc = Это не вечеринка если у тебя не болят глаза и уши, и ты не дизориентирован.
...
ent-CrateServicePhotocopierToners = ящик тонеров для копира
    .desc = Содержит запасные картриджи тонера для копировальных аппаратов.
