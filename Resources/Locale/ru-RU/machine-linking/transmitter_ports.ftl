...
signal-port-description-air-normal = Этот порт задействуется с высоким уровнем сигнала когда статус Нормальный, если статус другой, то с низким уровнем.
...
signal-port-description-item-detected = Этот порт вызывается каждый раз, когда передатчик обнаруживает предмет.
