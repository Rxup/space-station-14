...
delivery-spam-1 =   Робаст Тулбокс — Специальное предложение!
    .desc =         Реклама наборов инструментов Robust.
...
delivery-spam-3 =   Причины выбрать Синдикат!
    ...
    .content =      { -delivery-header-syndicate }
                    ...
                    { "[bold]ПРИЧИНА ТРИ[/bold]" }
                    ИХ МЕТОДЫ УБИЙСТВА ЛИШЕНЫ ВООБРАЖЕНИЯ! ПРОСТО РАССТРЕЛЫ! НЕ ВЫБРАСЫВАНИЕ ЛЮДЕЙ В КОСМОС, НЕ СКАРМЛИВАНИЕ ЛЮДЕЙ ПЕРЕРАБОТЧИКАМ МУСОРА С ВЫКЛЮЧЕННЫМ РЕЖИМОМ БЕЗОПАСНОСТИ, НЕ ПОДКИДЫВАНИЕ БОМБ В КАРМАНЫ! СКУКОТИЩА!
...
delivery-spam-5 =   БЕСССПЛАТНЫЙ ПОЛНЫЙ ДОСТУП!!
    .desc =         Хотели ли вы когда-нибудь бесплатный полный доступ?!
    .content =      [head=3]Вы когда-нибудь мечтали о [italic][color=green]Бесссплатном [bold]Полном доссступе!?!?[/bold][/color][/italic][/head] { "[head=2]ТЕПЕРЬ ВЫ МОЖЕТЕ ЕГО ПОЛУЩЩИТЬ!![/head]!" }
...
delivery-spam-6 =   УВЕДОМЛЕНИЕ ОТ НАНАТРАЗЕН!!
    .desc =         Официальное уведомление от генерального директора Нанотразен?!
...
delivery-spam-7 =   Отправьте подкрепление!
    ...
    .content =      { -delivery-header-nanotrasen-alternate-timeline }
                    { "[head=2]Это официальное уведомление от [color=red]Начальника Службы Безопасности[/color] Космической Станции 14 Nanotrasen.[/head]" }

                    Тому, кто получит это письмо. Я сержант Ригель. Я НСБ. Нам немедленно нужна помощь.

                    Наша станция сейчас под атакой Атомных Агентов, это письмо было брошено в дестабилизированную блюспейс-аномалию, созданную нашим [color=purple]Главой Научного Отдела[/color].

                    Я сейчас заболчен на Мостике, если вы получили это сообщение, пожалуйста, немедленно отправьте подмогу. Я не знаю, как долго мы ещё продержимся.
...
delivery-spam-9 =   Хочешь сразиться?!
    ...
    .content =      [color=#aaaaaa]▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀[/color] { "[bold][head=1]КЛЕТКА ЯРОСТИ[/head][/bold]" }
                                                { "[color=#aaaaaa]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[/color]" }
