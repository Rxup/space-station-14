# Скурреты с планеты Вава имеют два имени — «выбранное» и «качественное».

# «Выбранное имя» скуррет выбирает сам, отражая черту характера
# или ценность, которой он дорожит или которую стремится воплотить.
# Иногда скурреты меняют это имя, чтобы отметить важное событие в своей жизни.

# Часто целые семейные группы скурретов носят одинаковое выбранное имя.
# Получение собственного выбранного имени щенком символизирует его
# переход во взрослую жизнь в сообществе.

# Так как язык скурретов не переведён, эти имена обычно угадываются
# при помощи пантомимы или рисования (в духе «Крокодила» или Pictionary).

# Когда всё остальное не помогает, для NT и её экипажей имя «Ва»
...
names-scurret-first-dataset-23 = Чуткий
...
names-scurret-first-dataset-44 = Качающийся
...
# После консультации с юристами NT добавила это имя в словарь.
