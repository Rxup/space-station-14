...
uplink-pistol-viper-desc = Небольшой, легко скрываемый, но маломощный пистолет. Оснащён полностью автоматическим ресивером. Использует патроны калибра 5.7x28 мм.
uplink-estoc-bundle-name = Набор "Марксманская винтовка Эсток"
uplink-estoc-bundle-desc = Снайперская винтовка, оснащённая оптикой среднего диапазона для боя на дальних дистанциях. В комплекте с двумя магазинами для винтовки (.20 винтовка).
...
uplink-hushpup-desc = Мощный глушёный дробовик с малой ёмкостью магазина. Поставляется с запасной коробкой картечи. Использует патроны .50 для дробовика.
# Explosives
...
# Ammo
uplink-pistol-magazine-name = Пистолетный магазин (9x17 мм)
uplink-pistol-magazine-desc = Пистолетный магазин на 17 патронов. Совместим с Mk58 и другими пистолетами под 9x17 мм.
uplink-pistol-magazine-c20r-name = Магазин ПП (9x17 мм)
...
uplink-glimmer-wisp-familiar-name = Сияющий огонёк-фамильяр
uplink-glimmer-wisp-familiar-desc = Кристаллизованный осколок ноосферной энергии. При покупке сразу привязывается к вам, следует за вами и атакует угрозы поблизости разрядами и магическими снарядами.
...
uplink-combat-training-name = Имплантер боевой подготовки
uplink-combat-training-desc = Синдикатский имплант, повышающий точность стрельбы по выбранной части тела до уровня СБ (~35–40%).
combat-training-implanter-name = Имплантер боевой подготовки
combat-training-implanter-desc = Синдикатский имплантер, повышающий точность стрельбы.
combat-training-implant-name = Имплант боевой подготовки
combat-training-implant-desc = Повышает точность стрельбы по выбранной части тела до уровня СБ.
combat-marksmanship-implanter-admeme-name = Имплантер меткой стрельбы
combat-marksmanship-implanter-admeme-desc = Админский имплантер — 100% точность по выбранной части тела.
combat-marksmanship-implant-admeme-name = Имплант меткой стрельбы
combat-marksmanship-implant-admeme-desc = Админский имплант — 100% попадание в прицеленную часть тела.
...
uplink-saw-advanced-desc = Кровавый хирургический инструмент, способный с лёгкостью проходить через плоть и кости.
# Armor
...
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. У этого есть дополнительная броня и термоустойчивые ткани, но меньше защиты от пуль.
