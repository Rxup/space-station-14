...
tts-voice-name-hogwarts_poppy_sweeting = Poppy Sweeting (Hogwarts Legacy)
tts-voice-name-hogwarts_sebastian_sallow = Sebastian Sallow (Hogwarts Legacy)
tts-voice-name-hogwarts_player_female = Player (Hogwarts Legacy)
tts-voice-name-hogwarts_goblin_generic_a = Goblin Generic (Hogwarts Legacy)
tts-voice-name-hogwarts_player_male = Player (Hogwarts Legacy)
tts-voice-name-hogwarts_natsai_onai = Natsai Onai (Hogwarts Legacy)
tts-voice-name-hogwarts_eleazar_fig = Eleazar Fig (Hogwarts Legacy)
tts-voice-name-hogwarts_aesop_sharp = Aesop Sharp (Hogwarts Legacy)
tts-voice-name-hogwarts_ominis_gaunt = Ominis Gaunt (Hogwarts Legacy)
tts-voice-name-hogwarts_sophronia_franklin = Sophronia Franklin (Hogwarts Legacy)
tts-voice-name-hogwarts_abraham_ronen = Abraham Ronen (Hogwarts Legacy)
tts-voice-name-hogwarts_cuthbert_binns = Cuthbert Binns (Hogwarts Legacy)
tts-voice-name-hogwarts_lodgok = Lodgok (Hogwarts Legacy)
tts-voice-name-hogwarts_matilda_weasley = Matilda Weasley (Hogwarts Legacy)
tts-voice-name-hogwarts_mirabel_garlick = Mirabel Garlick (Hogwarts Legacy)
tts-voice-name-hogwarts_dinah_hecat = Dinah Hecat (Hogwarts Legacy)
tts-voice-name-halflife_gman = Gman (Half-Life: Alyx)
tts-voice-name-halflife_vortigaunt = Vortigaunt (Half-Life: Alyx)
tts-voice-name-halflife_larry = Larry (Half-Life: Alyx)
tts-voice-name-halflife_olga = Olga (Half-Life: Alyx)
tts-voice-name-halflife_alyx = Alyx (Half-Life: Alyx)
tts-voice-name-stronghold_richard = Richard (Stronghold Crusader)
tts-voice-name-stronghold_sultan = Sultan (Stronghold Crusader)
tts-voice-name-stronghold_emir = Emir (Stronghold Crusader)
tts-voice-name-stronghold_saladin = Saladin (Stronghold Crusader)
tts-voice-name-stronghold_abbot = Abbot (Stronghold Crusader)
tts-voice-name-stronghold_rat = Rat (Stronghold Crusader)
tts-voice-name-stronghold_halif = Halif (Stronghold Crusader)
tts-voice-name-stronghold_snake = Snake (Stronghold Crusader)
tts-voice-name-stronghold_friedrich = Friedrich (Stronghold Crusader)
tts-voice-name-stronghold_boar = Boar (Stronghold Crusader)
tts-voice-name-stalker_metro_bandit02 = Bandit02 (Metro)
tts-voice-name-stalker_metro_degtyarev = Degtyarev (Metro)
tts-voice-name-stalker_metro_novice02 = Novice02 (Metro)
tts-voice-name-stalker_metro_pavel = Pavel (Metro)
tts-voice-name-stalker_metro_saharov = Saharov (Metro)
tts-voice-name-stalker_metro_soldier = Soldier (Metro)
tts-voice-name-stalker_metro_stalker01 = Stalker01 (Metro)
tts-voice-name-stalker_metro_newbie01 = Newbie01 (Metro)
tts-voice-name-warcraft_garrosh = Garrosh (WarCraft 3)
