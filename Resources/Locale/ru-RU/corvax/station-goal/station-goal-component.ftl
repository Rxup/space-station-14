...
station-goal-weapon =
    ...
    Ящик дробовиков.
    Каждое пополнение арсенала должно быть задокументировано, а так же иметь печать главы службы безопастности.
    Проследите за сохранностью содержимого в арсенале до конца смены.
