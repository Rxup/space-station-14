...
xenoarch-trigger-tip-screwing = Отвинчивание
...
xenoarch-trigger-tip-examine = Близкий осмотр
xenoarch-trigger-tip-timer = Обычная само-активация
xenoarch-trigger-tip-blood = Кровь
xenoarch-trigger-tip-throw = Бросок
xenoarch-trigger-tip-death = Смерть
xenoarch-trigger-tip-magnet = Магнетические волны
xenoarch-trigger-examine-wrenching = Здесь есть незакреплённый кусок.
xenoarch-trigger-examine-prying = На поверхности есть панель.
xenoarch-trigger-examine-screwing = Здесь есть возвышенная секция с винтом на ней.
xenoarch-trigger-examine-pulsing = Открытые провода торчат из поверхности артефакта
xenoarch-trigger-examine-timer = Узоры и царапины на поверхности артефакта... Вы кое-как смогли посчитать их число: [italic]{ $time }[/italic]
xenoarch-effect-puddle = Производит лужу со следующими реагентами: { $reagent }
xenoarch-effect-foam = Производит пену со следующими реагентами: { $reagent }
