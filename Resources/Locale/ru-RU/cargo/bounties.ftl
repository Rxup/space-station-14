...
bounty-item-ore-bananium = Руда бананима
...
bounty-item-remains = Остатки Хивлорда
bounty-item-plates = Плиты из шкуры Голиафа
...
bounty-description-ring = В этот НЕОБЫЧНЫЙ день состоится свадьба между Гелтами, но мистер Гельт потерял кольца, пришлите пару колец.
