...
station-ai-customization-core = Отображения ядра ИИ
station-ai-customization-hologram = Голографические аватары
# Customizations
station-ai-icon-ai = Призрак в машине
station-ai-icon-angel = Страж-ангел
station-ai-icon-bliss = Упрощённое время
station-ai-icon-clown = Клоунские выходки
station-ai-icon-dorf = Приключения ждут
station-ai-icon-heartline = Линия жизни
station-ai-icon-smiley = Всё улыбается
station-ai-hologram-female = Женский облик
station-ai-hologram-male = Мужской облик
station-ai-hologram-face = Бесподобная голова
station-ai-hologram-cat = Котёнок
