...
chat-manager-entity-me-wrap-message = [font size=14][color=#FF4492][bold]*[/bold][/color] [italic]{ CAPITALIZE($entityName) }[/italic][bold][color=#FF4492] { $message }[/color][/bold][/font]
