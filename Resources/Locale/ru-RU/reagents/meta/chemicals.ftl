...
reagent-name-artifact-glue = Клей-артефакт
reagent-desc-artifact-glue = Смесь клея и артифексима. Позволяет восстановить прочность узлов артефакта при касании.
