...
reagent-desc-lacerinol = Довольно малоактивное вещество, которое увеличивает синтез коллагена до невероятных уровней, способствуя заживлению ран от резаных травм.
reagent-name-puncturase = пунктураз
reagent-desc-puncturase = Шипучее химическое вещество, которое помогает восстанавливать травмы, вызванные колющим уроном, оставляя небольшое количество поврежденной ткани.
reagent-name-bruizine = бруизин
reagent-desc-bruizine = Изначально разработанное как лекарство от кашля, оказалось, что это вещество чрезвычайно эффективно при лечении тупых травм.
