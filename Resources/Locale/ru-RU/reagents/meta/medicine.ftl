...
reagent-desc-arcryox = Тошнотворно синий криогенный химикат, способный залечивать крайне тяжёлые раны даже на мёртвых. Однако у него возникают проблемы со стабилизацией пациентов.
...
reagent-name-desiccant = десикант
reagent-desc-desiccant = Порошковое лекарство, которое лечит болезнь "Мокрые руки", поглощая избыточную влагу с рук.
