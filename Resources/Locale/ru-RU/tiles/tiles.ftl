...
tiles-rcd-plating = RCD покрытие
...
tiles-asteroid-ironsand-borderless = железопесочный астероид без границ
tiles-cave = пещера
...
tiles-dirt-planet-floor = пол грязи планеты
...
tiles-astro-asteroid-sand-borderless = астро-песок астероида без границ
