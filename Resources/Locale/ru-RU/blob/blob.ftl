...
blobberaut-not-on-blob-tile = Вы умираете пока не находитесь на клетках блоба.
blobberaut-factory-destroy = Вы умираете, поскольку ваша фабрика была разрушена.
carrier-blob-alert = Осталось { $second } секунд до трансформации.
...
# Greeting
blob-role-greeting = Вы блоб - космический паразит который захватывает станции.
