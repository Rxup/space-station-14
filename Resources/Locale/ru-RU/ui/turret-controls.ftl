...
turret-controls-window-turret-broken = ***НЕРАБОТОСПОСОБНО***
# Buttons
...
# Flavor
turret-controls-window-footer = Неавторизованный персонал должен убедиться, что защита неактивна перед продолжением
# Warnings
