...
organs-category-brain = мозг
organs-category-stomach = желудок
organs-category-liver = печень
organs-category-kidneys = почки
organs-category-eyes = глаза
organs-category-tongue = язык
