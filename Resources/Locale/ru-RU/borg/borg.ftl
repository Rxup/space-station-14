...
borg-transponder-disabling-popup = Ваш транспондер начинает блокировать доступ к оболочке!
...
borg-select-type-menu-bottom-text = Выбор оболочки является необратимым
borg-select-type-menu-available = Доступные:
borg-select-type-menu-information = Информация
borg-select-type-menu-select-type = Выберите тип оболочки для просмотра информации
