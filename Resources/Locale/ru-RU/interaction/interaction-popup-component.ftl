...
petting-success-mail-teleporter = Вы гладите { $target } по {POSS-ADJ($target)} послушному, холодному корпусу.
petting-failure-mail-teleporter = Вы тянетесь погладить { $target }, но {SUBJECT($target)} {CONJUGATE-BE($target)} занят сортировкой писем!
