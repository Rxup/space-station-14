...
alert-level-iota = Йота
alert-level-iota-announcement = На станции был объявлен код йота. Экипаж, настоятельно просим соблюдать спокойствие. В связи с тяжёлой ситуации на станции была объявлена экстренная эвакуация, всему персоналу слушаться глав отделов и капитана для получений подальших распоряжений об эвакуации. 
alert-level-iota-instructions = Экипажу рекомендуется укрыться в безопасном месте, желательно в своём отделе и ожидать команды об эвакуации, в случаи угрозы безопасности экипажа и процесса эвакуации, сообщить службе безопасности. Также рекомендуется поставить датчики костюма в режим "Координат".
...
alert-level-sintwave-announcement = Центральное командование объявило на станции уровень угрозы "Синтвейв". Весь персонал освобождается от своих обязанностей на время действия кода. HONK TIME!
...
alert-level-sigma-announcement = Всем необходимо сохранять спокойствие и проследовать в свой отдел для получения указаний от глав.
alert-level-white = Белый
alert-level-white-announcement = Уровень сияния на станции приближается к опасному уровню. Отключите все датчики сияния. Ищите псионическую изоляцию. РнД должны сообщать о взломе разума или големолизации. Штраф за оба действия снят.
