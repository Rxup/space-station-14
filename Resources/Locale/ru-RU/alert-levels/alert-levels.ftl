...
alert-level-epsilon-tango-announcement = Система находится под серьёзной угрозой и может быть потеряна. Центральное командование сектора отзывает любые права разумных существ и устанавливает абсолютное верховенство военного права на объекте. Все сотрудники обязаны беспрекословно подчиняться старшим по иерархии. Любое нарушение карается военным полевым судом с возможным применением смертной казни.
alert-level-epsilon-tango-instructions = Ваша судьба в руках отряда эскадора смерти.
