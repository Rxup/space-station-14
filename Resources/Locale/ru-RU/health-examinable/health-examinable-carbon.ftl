...
health-examinable-carbon-Blunt-50 = [color=red]{ CAPITALIZE(SUBJECT($target)) } сильно { CONJUGATE-BE($target) }.[/color]
...
health-examinable-carbon-Blunt-75 = [color=red]{ CAPITALIZE(SUBJECT($target)) } тело покрыто серьёзными тупыми травмами.[/color]
...
health-examinable-carbon-Piercing-75 = [color=red]{ CAPITALIZE(SUBJECT($target)) } тело покрыто обширными глубокими разрывами тканей.[/color]
...
health-examinable-carbon-Slash-50 = [color=red]{ CAPITALIZE(SUBJECT($target)) } тело покрыто глубокими порезами.[/color]
health-examinable-carbon-Slash-75 = [color=red]{ CAPITALIZE(SUBJECT($target)) } тело покрыто глубокими рваными ранами.[/color]
...
health-examinable-carbon-Shock-15 = [color=lightgoldenrodyellow]На { CAPITALIZE(SUBJECT($target)) } коже лёгкие следы обугливания.[/color]
health-examinable-carbon-Shock-30 = [color=lightgoldenrodyellow]{ CAPITALIZE(SUBJECT($target)) } тело покрыто следами обугливания.[/color]
health-examinable-carbon-Piercing-50 = [color=red]{ CAPITALIZE(SUBJECT($target)) } тело покрыто серьёзными глубокими проколами.[/color]
health-examinable-carbon-Shock-75 = [color=lightgoldenrodyellow]{ CAPITALIZE(SUBJECT($target)) } тело покрыто большими обугленными ранами.[/color]
health-examinable-carbon-Shock-100 = [color=lightgoldenrodyellow]Всё { CAPITALIZE(POSS-ADJ($target)) } покрыто сильными электрическими ожогами![/color]
health-examinable-carbon-Shock-200 = [color=lightgoldenrodyellow]{ CAPITALIZE(POSS-ADJ($target)) } тело полностью зажарено![/color]

health-examinable-carbon-Cold-8 = [color=lightblue]На кончиках { CAPITALIZE(SUBJECT($target)) } конечностей лёгкие обморожения.[/color]
health-examinable-carbon-Cold-15 = [color=lightblue]На концах { CAPITALIZE(SUBJECT($target)) } конечностей обморожения первой степени.[/color]
health-examinable-carbon-Cold-30 = [color=lightblue]На { CAPITALIZE(SUBJECT($target)) } конечностях обморожения второй степени.[/color]
health-examinable-carbon-Heat-25 = [color=orange]{ CAPITALIZE(SUBJECT($target)) } { CONJUGATE-HAVE($target) } лёгкие ожоги на теле.[/color]
health-examinable-carbon-Heat-50 = [color=orange]{ CAPITALIZE(SUBJECT($target)) } { CONJUGATE-BE($target) } ожогами второй степени.[/color]
...
health-examinable-carbon-Shock-50 = [color=lightgoldenrodyellow]{ CAPITALIZE(SUBJECT($target)) } тело серьёзно обуглено.[/color]
health-examinable-carbon-Caustic-100 = [color=yellowgreen]{ CAPITALIZE(SUBJECT($target)) } тело покрыто сильными химическими ожогами.[/color]
...
health-examinable-carbon-Cold-50 = [color=lightblue]На { CAPITALIZE(SUBJECT($target)) } конечностях сильные обморожения третьей степени.[/color]
