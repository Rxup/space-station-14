...
id-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} бедре.
head-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} голове.
eyes-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} глазах.
mask-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} лице.
neck-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} шее.
ears-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} ушах.
jumpsuit-examine = - {CAPITALIZE(POSS-ADJ($ent))} носит [bold]{$item}[/bold] {SUBJECT($ent)} на себе.
outer-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} теле.
suitstorage-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} плечах.
back-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} спине.
gloves-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} руках.
belt-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {SUBJECT($ent)} поясе.
shoes-examine = - {CAPITALIZE(POSS-ADJ($ent))} [bold]{$item}[/bold] на {POSS-ADJ($ent)} ногах.
...
id-examine-selfaware = - [bold]{$item}[/bold] на вашем бедре.
