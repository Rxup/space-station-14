...
# Addictions
mood-effect-LotoTranscendence = Я ВИЖУ ВСЁ СУЩЕЕ, КОТОРОЕ ВСЕГДА БЫЛО И ВСЕГДА БУДЕТ. ВСЁ МИРОЗДАНИЕ ОТКРЫЛОСЬ МОЕМУ РАЗУМУ!
    Я ДОЛЖЕН ЗНАТЬ ЭТО. Я ДОЛЖЕН ХРАНИТЬ ВСЁ ЭТО. ВСЁ. ВЕЧНО!
mood-effect-LotoEnthrallment = Оно ушло от меня... Сердце всего сущего пропало из моей души, оставляя неописуемую пустоту внутри.
