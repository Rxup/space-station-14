...
ion-storm-law-must-harmful = ТЕ, КТО {ION-MUST($ion)}, ПРИЧИНЯЮТ ВРЕД ЗДОРОВЬЮ ЭКИПАЖА
...
ion-storm-law-highest-rank = {ION-WHO-RANDOM($ion)} ТЕПЕРЬ ИМЕЮТ НАИВЫСШИЙ РАНГ СРЕДИ ЭКИПАЖА
ion-storm-law-lowest-rank = {ION-WHO-RANDOM($ion)} ТЕПЕРЬ ИМЕЮТ НАИНИЗШИЙ РАНГ СРЕДИ ЭКИПАЖА
