...
battery-menu-charge-header = Поменять Плату
battery-menu-discharge-header = Разрядить Плату
battery-menu-storage-header = Ячейки Питания
battery-menu-passthrough = Проходной
battery-menu-max = Макс:
battery-menu-current = Текущее:
battery-menu-stored = Хранится:
battery-menu-energy = Энергия:
battery-menu-eta-full = ETA (полное):
battery-menu-eta-empty = ETA (пустое):
