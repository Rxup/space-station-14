...
admin-manager-admin-permissions-updated-message = Ваши права были обновлены.
admin-manager-admin-logout-message = Админ вышел: { $name }
admin-manager-admin-login-message = Админ зашёл: { $name }
admin-manager-admin-data-host-title = Глава сервера
...
admin-manager-self-enable-stealth = { $stealthAdminName } скрывает свою должность в adminwho.
