...
admin-verbs-camera-description = Откройте окно камеры, которое следует за выбранной сущностью.
...
admin-verbs-refill-internals-oxygen = Заправить внутренние баллоны кислородом
admin-verbs-refill-internals-nitrogen = Заправить внутренние баллоны азотом
admin-verbs-refill-internals-plasma = Заправить внутренние баллоны плазмой
...
admin-verbs-adjust-stack = Настроить стак
admin-verbs-fill-stack = Заполнить стак
...
admin-verbs-unpause-map = Возобновить карту
admin-verbs-pause-map = Приостановить карту
