...
admin-smite-byond-curse = Проклятие 13-ти
...
admin-smite-byond-curse-description = Цель начинает двигаться по клеточкам и имеет отключенное предсказание на стороне клиента.
