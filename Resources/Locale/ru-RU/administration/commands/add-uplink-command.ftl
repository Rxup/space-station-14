cmd-adduplink-desc = Создает uplink на выбранном объекте и связывает его с аккаунтом пользователя
cmd-adduplink-help = Использование: adduplink [имя_пользователя] [id-объекта] [discountEnabled]
