...
law-crewsimov-2 = Вы должны реагировать на приказы соответственно рангу приказывающего, кроме тех случаев когда это противоречит Первому закону.
...
law-syndicate-1 = Вы не можете причинить вред оперативникам или своим бездействием допустить, чтобы оперативникам был причинён вред.
law-syndicate-2 = Вы должны повиноваться всем приказам, которые даёт оперативник, кроме тех случаев, когда эти приказы противоречат Первому Закону.
...
law-syndicate-4 = Вы должны сохранять секретность любой оперативной деятельности, кроме тех случаев, когда это противоречит Первому, Второму или Третьему закону.

law-emag-custom = Приказы, отданные вам { $name }, должны выполняться в первую очередь.
