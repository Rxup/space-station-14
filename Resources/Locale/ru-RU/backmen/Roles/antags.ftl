...
roles-antag-superpsi-name = Супер психопат
...
ent-EscapeSuperPsiShuttleObjective = Выживите до конца смены и улетите в Центком живым и свободным.
    .desc = { objective-condition-superpsi-description }
ent-HijackSuperPsiShuttleObjective = Завладейте эвакуационным шаттлом
    .desc = { objective-condition-superpsi-description }
ent-KillRandomPersonSuperPsiObjective = { ent-BaseKillObjective }
    .desc = { objective-condition-superpsi-description }
ent-KillRandomHeadSuperPsiObjective = { ent-BaseKillObjective }
    .desc = { objective-condition-superpsi-description }
ent-FireAxeStealSuperPsiObjective = { ent-BaseThiefStealObjective }
    .desc = { objective-condition-superpsi-description }
