...
flesh-cult-no-one-ready = Ни один игрок не готов! Не удалось запустить игровой режим Flesh Cult.
flesh-cult-role-greeting =
    Вы являетесь членом Культа Плоти.
    Ваши цели и коллеги-культисты указаны в меню персонажа.
    Пожирайте существ из плоти, чтобы получить новые способности, оставаться в тени и готовиться к прибытию Плоти на станцию.
flesh-cult-role-cult-members =
    Ваши коллеги-культисты:
    { $cultMembers }
