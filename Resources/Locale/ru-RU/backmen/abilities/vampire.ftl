...
objective-bloodsucker-drink-desc = Выпейте крови из чистокровных существ, учитывается сколько крови вы собрали на данный момент, а не сколько у вас есть на самом деле.
