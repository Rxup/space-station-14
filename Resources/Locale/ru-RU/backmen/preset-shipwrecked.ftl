...
shipwrecked-list-survived-name = - [color=white]{ $name }[/color] брошен при запуске...
shipwrecked-list-stranded-name = - [color=white]{ $name }[/color] остался на планете.
...
shipwrecked-hecate-response-status-need-thrusters =
    Для взлёта нужны все { $totalThrusterCount } двигателей — включены, с питанием и направлены во все стороны.
    Исправно: { $goodThrusterCount } из { $totalThrusterCount }, направлений тяги: { $directionCount } из 4.
shipwrecked-hecate-response-status-need-generator =
    Для взлёта шаттлу нужно { $powerDemand } Вт от запущенных генераторов.
    Сейчас выдают { $currentSupply } Вт (установлено на борту: { $installedSupply } Вт) — { $status }.
shipwrecked-hecate-generator-status-sufficient = достаточно
shipwrecked-hecate-generator-status-insufficient = недостаточно
...
shipwrecked-hecate-response-status-all-green-first =
    Похоже, всё готово к взлёту: { $powerDemand } Вт, { $totalThrusterCount } двигателей — всё в порядке. Скажите, когда запускать.
shipwrecked-hecate-response-status-all-green-again =
    Мы готовы к запуску: { $powerDemand } Вт, { $totalThrusterCount } двигателей в порядке.
# Pre-launch
