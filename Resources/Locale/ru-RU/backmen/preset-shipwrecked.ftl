...
hecate-start-play-music = Чтобы вы не скучали, включаю музыку: "Kujlevka OST - Поезд на Сатурн". Приятного полёта.
...
shipwrecked-hecate-response-supplies = Это судно снабжено разнообразным исследовательским инвентарём и предметами для скучного времяпрепровождения. Пожалуйста, наслаждайтесь.
# Post-crash
