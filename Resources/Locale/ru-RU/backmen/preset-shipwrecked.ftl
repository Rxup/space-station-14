...
shipwrecked-hecate-report-decouple-engine = Обнаружен сбой в прыжковом приводе, вызвавший аномалию, несоответствующую законам физики. Необходимо немедленно отсоединить двигатель для предотвращения катастрофы и спасения экипажа.
...
shipwrecked-hecate-aftercrash-sitrep = Что ж... это прискорбно. Похоже, мы получили серьезные повреждения. Я сделаю все возможное, чтобы помочь вам. Например можете попросить меня разблокировать генератор или оружие!
...
hecate-qa-user-interface = Если у вас возникнут вопросы, просто назовите мое имя и спросите. В остальное время я буду заниматься калибровкой корабельных систем.
hecate-start-play-music = Чтобы вы не скучали, я включу вам музыку: "Kujlevka OST - Поезд на Сатурн". Приятного полёта.
...
shipwrecked-hecate-response-supplies = Это судно снабжено разнообразным грузом и предметами для скучного времяпрепровождения. Пожалуйста, наслаждайтесь.
# Post-crash
...
shipwrecked-hecate-response-scans = Суборбитальное сканирование показало наличие руин во всех 8 направлениях от места крушения, возможно содержание внеземных форм жизни. Пожалуйста, будьте осторожны.
shipwrecked-hecate-response-weapons-before = В кабине есть оружейный сейф, а в грузовом отсеке немного утилизационного снаряжения. Блокировки сняты. Пожалуйста, будьте осторожны.
shipwrecked-hecate-response-weapons-after = Все блокировки уже сняты. Обращайтесь с оружием осторожно.
shipwrecked-hecate-response-status = Оценка ситуации...
shipwrecked-hecate-response-status-need-thrusters = Для взлета нам необходим полный комплект двигателей. Сейчас мною зафиксировано только { $goodThrusters }.
...
# Pre-launch
shipwrecked-hecate-response-launch-need-thrusters = Похоже, что расположение двигателей изменилось. Сейчас я могу обнаружить только { $goodThrusters } двигателей.
