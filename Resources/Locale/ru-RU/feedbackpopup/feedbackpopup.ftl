...
command-description-feedback-remove = Удаляет прототип обратной связи у указанных клиентов.

feedbackpopup-give-command-name = givefeedbackpopup
feedbackpopup-show-command-name = showfeedbackpopup
cmd-givefeedbackpopup-desc = Выдаёт игроку окно обратной связи.
...
feedbackpopup-command-error-invalid-proto = Неверный прототип обратной связи.
feedbackpopup-command-error-popup-send-fail = Не удалось отправить окно! Вероятно, к сущности не привязан разум.
