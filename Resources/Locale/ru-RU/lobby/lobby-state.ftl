...
lobby-state-song-text = Играет: [color=white]{ $songArtist }[/color] - [color=white]{ $songTitle }[/color]
...
lobby-state-playtime-comment-concerning = ты уже играешь {$hours} час\часов. пожалуйста, потрогай траву.
