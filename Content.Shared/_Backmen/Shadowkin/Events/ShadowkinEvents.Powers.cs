...
namespace Content.Server._Backmen.Species.Shadowkin.Events;
...
{
    [DataField("sound")]
    public SoundSpecifier Sound = new SoundPathSpecifier("/Audio/_Backmen/Effects/Shadowkin/Powers/teleport.ogg");
...
{
    [DataField("soundOn")]
    public SoundSpecifier SoundOn = new SoundPathSpecifier("/Audio/_Backmen/Effects/Shadowkin/Powers/darkswapon.ogg");

    [DataField("volumeOn")]
    public float VolumeOn = 5f;

    [DataField("soundOff")]
    public SoundSpecifier SoundOff = new SoundPathSpecifier("/Audio/_Backmen/Effects/Shadowkin/Powers/darkswapoff.ogg");
