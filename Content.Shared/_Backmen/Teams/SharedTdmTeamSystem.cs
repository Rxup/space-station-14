...
namespace Content.Shared._Backmen.Teams;
...
public abstract class SharedTdmTeamSystem : EntitySystem
{
    ...
    private void GetVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        if(team != StationTeamMarker.TeamA)
        {
            ...
            verb.Icon = new SpriteSpecifier.Texture(new("/Textures/_Backmen/Interface/Misc/svs_icon.rsi/team_a.png"));
            verb.Act = () =>
            {
        ...
        if(team != StationTeamMarker.TeamB)
        {
            ...
            verb.Category = VerbCategory.Tricks;
            verb.Icon = new SpriteSpecifier.Texture(new("/Textures/_Backmen/Interface/Misc/svs_icon.rsi/team_b.png"));
            verb.Act = () =>
            {
        ...
        if(team != StationTeamMarker.Neutral)
        {
            ...
            verb.Category = VerbCategory.Tricks;
            verb.Icon = new SpriteSpecifier.Texture(new("/Textures/_Backmen/Interface/Misc/svs_icon.rsi/team_0.png"));
            verb.Act = () =>
            {
