...
public sealed partial class CosmicCultComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public TimeSpan CosmicSiphonDelay = TimeSpan.FromSeconds(2);

    /// <summary>
    /// The duration of the doAfter for Shunt Subjectivity
    /// </summary>
    [DataField]
    public TimeSpan CosmicBlankDelay = TimeSpan.FromSeconds(0.6f);
    ...
    /// </summary
    [DataField]
    public TimeSpan CosmicEntropyDebuffDuration = TimeSpan.FromSeconds(21);
