...
namespace Content.Shared.Backmen.Xenobiology.Systems;
...
public partial class XenobiologySystem
{
    ...
    private void OnInteractionSuccess(Entity<SlimeComponent> ent, ref InteractionSuccessEvent args)
    {
        ...
        {
            _popup.PopupEntity(Robust.Shared.Localization.Loc.GetString("slime-interaction-tame-fail"), args.User, args.User);
            return;
        }
        ...
        _popup.PopupEntity(Robust.Shared.Localization.Loc.GetString("slime-interaction-tame"), args.User, args.User);
