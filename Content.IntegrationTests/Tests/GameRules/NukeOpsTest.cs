...
public sealed class NukeOpsTest
{
    ...
    public async Task TryStopNukeOpsFromConstantlyFailing()
    {
        ...
        Assert.That(entMan.Count<StationDataComponent>(), Is.EqualTo(3)); // The main station & nukie station & centcom station
        Assert.That(entMan.Count<StationMemberComponent>(), Is.GreaterThan(4)); // Each station has at least 1 grid, plus some shuttles, plus centcom
