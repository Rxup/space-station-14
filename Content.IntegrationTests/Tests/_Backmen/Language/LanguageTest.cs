...
using Content.Server._Backmen.Blob.NPC.BlobPod;
using Content.Server._Backmen.Cloning.Components;
...
namespace Content.IntegrationTests.Tests._Backmen.Language;
