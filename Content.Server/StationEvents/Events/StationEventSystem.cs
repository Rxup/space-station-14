...
public abstract class StationEventSystem<T> : GameRuleSystem<T> where T : IComponent
{
    ...
    protected override void Added(EntityUid uid, T component, GameRuleComponent gameRule, GameRuleAddedEvent args)
    {
        ...
        if (stationEvent.StartAnnouncement != null)
            ChatSystem.DispatchGlobalAnnouncement(Loc.GetString(stationEvent.StartAnnouncement), playSound: stationEvent.StartAudio == null, colorOverride: stationEvent.StartAnnouncementColor);
    ...
    protected override void Ended(EntityUid uid, T component, GameRuleComponent gameRule, GameRuleEndedEvent args)
    {
        ...
        if (stationEvent.EndAnnouncement != null)
            ChatSystem.DispatchGlobalAnnouncement(Loc.GetString(stationEvent.EndAnnouncement), playSound: stationEvent.EndAudio == null, colorOverride: stationEvent.EndAnnouncementColor);
