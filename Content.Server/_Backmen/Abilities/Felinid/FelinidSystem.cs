...
namespace Content.Server._Backmen.Abilities.Felinid;
...
public sealed class FelinidSystem : EntitySystem
{
    ...
    private static readonly SoundSpecifier HairballPlay = new SoundPathSpecifier("/Audio/_Backmen/Effects/Species/hairball.ogg",
