using Content.Server._Backmen.Cocoon;
using Content.Shared._Backmen.Arachne;
...
using Content.Shared._Backmen.Abilities;
...
namespace Content.Server._Backmen.Arachne;
