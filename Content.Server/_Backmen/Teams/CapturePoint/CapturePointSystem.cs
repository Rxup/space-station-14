...
using Content.Shared._Backmen.Teams.CapturePoint;
using Content.Shared._Backmen.Teams.CapturePoint.Components;
...
namespace Content.Server._Backmen.Teams.CapturePoint;
