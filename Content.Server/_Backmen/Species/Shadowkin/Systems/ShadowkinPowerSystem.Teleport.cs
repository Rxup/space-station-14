using Content.Server._Backmen.Species.Shadowkin.Components;
using Content.Server._Backmen.Species.Shadowkin.Events;
...
namespace Content.Server._Backmen.Species.Shadowkin.Systems;
...
public sealed class ShadowkinTeleportSystem : EntitySystem
{
    ...
    private static SoundSpecifier _soundTeleport = new SoundPathSpecifier("/Audio/_Backmen/Effects/Shadowkin/Powers/teleport.ogg");
