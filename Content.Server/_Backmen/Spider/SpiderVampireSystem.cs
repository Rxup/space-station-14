using Content.Shared._Backmen.Spider.Components;
...
namespace Content.Server._Backmen.Spider;
...
public sealed class SpiderVampireSystem : EntitySystem
{
    ...
    private static readonly SoundSpecifier HairballPlay =
        new SoundPathSpecifier("/Audio/_Backmen/Effects/Species/hairball.ogg", AudioParams.Default.WithVariation(0.15f));
