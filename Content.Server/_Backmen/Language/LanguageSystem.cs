...
using Content.Shared._Backmen.Language.Components;
using Content.Shared._Backmen.Language.Systems;
using Robust.Shared.Prototypes;
using UniversalLanguageSpeakerComponent = Content.Shared._Backmen.Language.Components.UniversalLanguageSpeakerComponent;

namespace Content.Server._Backmen.Language;
