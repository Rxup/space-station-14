...
using Content.Server._Backmen.Administration.Bwoink.Gpt.Models;
...
namespace Content.Server._Backmen.Administration.Bwoink.Gpt;
...
public sealed class GptAhelpSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(Shared._Backmen.CCVar.CCVars.GptEnabled, GptEnabledCVarChanged, true);
        _cfg.OnValueChanged(Shared._Backmen.CCVar.CCVars.GptApiUrl, GptUrlCVarChanged, true);
        _cfg.OnValueChanged(Shared._Backmen.CCVar.CCVars.GptApiToken, GptTokenCVarChanged, true);
        _cfg.OnValueChanged(Shared._Backmen.CCVar.CCVars.GptModel, GptModelCVarChanged, true);
        _cfg.OnValueChanged(Shared._Backmen.CCVar.CCVars.GptApiGigaToken, GptGigaTokenCVarChanged, true);
        _cfg.OnValueChanged(Shared._Backmen.CCVar.CCVars.GptApiNoAdminAuto, v => { EnabledNoAdminAutoResponse = v; }, true);
    ...
    {
        _cfg.UnsubValueChanged(Shared._Backmen.CCVar.CCVars.GptEnabled, GptEnabledCVarChanged);
        _cfg.UnsubValueChanged(Shared._Backmen.CCVar.CCVars.GptApiUrl, GptUrlCVarChanged);
        _cfg.UnsubValueChanged(Shared._Backmen.CCVar.CCVars.GptApiToken, GptTokenCVarChanged);
        _cfg.UnsubValueChanged(Shared._Backmen.CCVar.CCVars.GptApiGigaToken, GptGigaTokenCVarChanged);
