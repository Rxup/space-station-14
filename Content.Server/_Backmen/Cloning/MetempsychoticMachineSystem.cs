using Content.Server._Backmen.Psionics;
using Content.Server.Ghost.Roles.Components;
using Content.Server.Humanoid;
using Content.Server.Speech.Components;
using Content.Server.StationEvents.Components;
using Content.Shared._Backmen.Psionics.Components;
...
namespace Content.Server._Backmen.Cloning;
...
public sealed class MetempsychoticMachineSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<Server._Backmen.Cloning.CloningSpawnEvent>(OnCloning);
