...
using Content.Shared._Backmen.Cocoon;
...
namespace Content.Server._Backmen.Cocoon;
...
public sealed class CocoonerSystem : EntitySystem
{
    ...
    private void AddSuccVerb(EntityUid uid, CocoonComponent component, GetVerbsEvent<AlternativeVerb> args)
    {
        ...
        AlternativeVerb verb = new()
        {
            ...
            Icon = new SpriteSpecifier.Texture(new("/Textures/_Nyanotrasen/Icons/verbiconfangs.png")),
            Priority = 2
        };
        args.Verbs.Add(verb);
    }
