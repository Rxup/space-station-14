...
namespace Content.Server._Backmen.Economy.Wage;
...
public sealed class WageManagerSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        _configurationManager.OnValueChanged(Shared._Backmen.CCVar.CCVars.EconomyWagesEnabled, SetEnabled, true);
    ...
    {
        base.Shutdown();
        _configurationManager.UnsubValueChanged(Shared._Backmen.CCVar.CCVars.EconomyWagesEnabled, SetEnabled);
    }
