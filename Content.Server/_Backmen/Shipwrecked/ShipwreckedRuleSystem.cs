...
using Content.Server._Backmen.NPC.Prototypes;
using Content.Server._Backmen.NPC.Systems;
using Content.Server._Backmen.Shipwrecked.Components;
using Content.Server._Backmen.Shipwrecked.Prototypes;
...
namespace Content.Server._Backmen.Shipwrecked;
...
*/
    ...
    private bool SpawnHecate(Entity<ShipwreckedRuleComponent> ent)
    {
        ...
        foreach(var (_, meta, xform, _) in GetSpawnPointsAll(ent.Comp.Shuttle!.Value, ent))
        {
            ...
            _audioSystem.PlayPvs(new SoundPathSpecifier("/Audio/_Nyanotrasen/Mobs/Hologram/hologram_start.ogg"), ent.Comp.Hecate.Value);
    ...
    private void CrashShuttle(EntityUid uid, ShipwreckedRuleComponent component)
    {
        ...
        var crashSound = new SoundPathSpecifier("/Audio/_Nyanotrasen/Effects/crash_impact_metal.ogg");
