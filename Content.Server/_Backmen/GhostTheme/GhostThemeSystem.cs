...
namespace Content.Server._Backmen.GhostTheme;
...
public sealed class GhostThemeSystem : EntitySystem
{
    ...
    {
        var prefGhost = _netConfigManager.GetClientCVar(args.Player.Channel, Shared._Backmen.CCVar.CCVars.SponsorsSelectedGhost);
        {
#if DEBUG
