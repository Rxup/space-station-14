...
using Content.Shared._Backmen.JoinQueue;
...
namespace Content.Server._Backmen.JoinQueue;
...
public sealed class JoinQueueManager : Content.Corvax.Interfaces.Server.IServerJoinQueueManager
{
    ...
    public void Initialize()
    {
        ...
        _cfg.OnValueChanged(Shared._Backmen.CCVar.CCVars.QueueEnabled, OnQueueCVarChanged, true);
