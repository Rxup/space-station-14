...
using System.Linq;
using Content.Shared._Backmen.Surgery;
using Content.Shared._Backmen.Surgery.Effects.Step;
...
namespace Content.Server._Backmen.Surgery;
...
public sealed class SurgerySystem : SharedSurgerySystem
{
    ...
    private void AttemptStartSurgery(Entity<SurgeryToolComponent> ent, EntityUid user, EntityUid target)
    {
        ...
        if (user == target && !_config.GetCVar(Shared._Backmen.CCVar.CCVars.CanOperateOnSelf))
        {
