using Content.Shared._Backmen.EnergyDome;
using Content.Shared.DeviceLinking;
using Robust.Shared.Audio;
using Robust.Shared.Prototypes;

namespace Content.Server._Backmen.EnergyDome;
...
public sealed partial class EnergyDomeGeneratorComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier EnergyOutSound = new SoundPathSpecifier("/Audio/_Backmen/Effects/energyshield_down.ogg");
    [DataField]
    public SoundSpecifier TurnOffSound = new SoundPathSpecifier("/Audio/Machines/button.ogg");
    [DataField]
    public SoundSpecifier ParrySound = new SoundPathSpecifier("/Audio/_Backmen/Effects/energyshield_parry.ogg")
    {
