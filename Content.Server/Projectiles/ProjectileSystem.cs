...
public sealed partial class ProjectileSystem : SharedProjectileSystem
{
    ...
    private void OnStartCollide(EntityUid uid, ProjectileComponent component, ref StartCollideEvent args)
    {
        ...
        // start-backmen: reflector
        if (_damageableSystem.TryChangeDamage((target, damageableComponent), ev.Damage, out var damage, component.IgnoreResistances, origin: component.Shooter, seedEntity: uid) && Exists(component.Shooter))
        {
            if (Exists(target))
            {
