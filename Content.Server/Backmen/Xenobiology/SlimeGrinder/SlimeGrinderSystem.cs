...
namespace Content.Server.Backmen.Xenobiology.SlimeGrinder;
...
{
    [Dependency] private readonly Shared.Backmen.Xenobiology.Systems.XenobiologySystem _xenobio = default!;
