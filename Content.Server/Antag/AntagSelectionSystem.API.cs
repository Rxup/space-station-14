...
public sealed partial class AntagSelectionSystem
{
    ...
    [PublicAPI]
    public int GetTargetAntagCount(Entity<AntagSelectionComponent> gameRule, int? playerCount = null)
    {
        return GetTotalAntagCount(gameRule, playerCount ?? GetActivePlayerCount());
    }
    ...
    {
        // First check our mindroles.
        if (_role.PlayerIsExclusiveAntagonist(player))
            return true;
